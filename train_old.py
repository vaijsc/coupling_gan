...
def train(args):
    ...
    # Set potential
    if args.dataset in ['mnist','cifar10','cifar10+mnist', 'cifar10+3mnist', 'cifar10+5mnist', 'stl10', 'mnist_cifar10', 'mnist12', 'cifar10+7mnist', 'cifar10+10mnist', 'fashion_mnist_5p_mnist', 'mnist021']:
