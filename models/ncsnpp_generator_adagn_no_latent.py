...
ResnetBlockBigGANNoLatent = layerspp.ResnetBlockBigGANpp_Adagn_No_Latent
...
class NCSNpp(nn.Module):
  ...
  def __init__(self, config):
    ...
    elif resblock_type == 'biggan_no_latent':
      ResnetBlock = functools.partial(ResnetBlockBigGANNoLatent,
                                      act=act,
                                      dropout=dropout,
                                      fir=fir,
