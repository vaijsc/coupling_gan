...
def sample_and_test(args, epoch_id):
    ...
    parent_dir = f"./train_logs/{args.dataset}"
    ...
    if args.dataset in ['cifar10', 'cifar10+3mnist', 'cifar10+5mnist', 'cifar10+7mnist', 'cifar10+10mnist']:
    ...
    elif args.dataset in ['celeba_256', 'celeba_64_5p_fashion']:
    ...
    elif args.dataset == 'celeba_256_5p_fashion_mnist':
        real_img_dir = 'pytorch_fid/celeba2_train_stat.npy'
    else:
